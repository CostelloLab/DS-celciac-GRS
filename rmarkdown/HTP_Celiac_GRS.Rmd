...
grs_wrapper <- function(DS_dosage = DS_dosage, control_subjects = control_subjects, celiac_subjects = celiac_subjects, test_iterations = 10, control_to_case_ratio = 3, snp = snp, sampling_iterations = 10, k = 1) {
  ...
  # plot the roc curves
    ...
    print(rocs)
    return(list(GRS = GRS, ROC_plot = p1, weights_plot = p2, accuracies_plot = p3))
...
k1 <- grs_wrapper(DS_dosage = DS_dosage, control_subjects = control_subjects, celiac_subjects = celiac_subjects, test_iterations = 10 , control_to_case_ratio = 3, snp = snp, sampling_iterations = 500, k = 1)
